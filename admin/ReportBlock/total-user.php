                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php $ret = mysqli_query($conn, "select * from user_profile");
                                    $cnt = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php 
                                                    if ($superadmin=='yes'){ ?>
                                                <a href="total-user.php?id=<?php echo $row['userid']; ?>" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <?php } 
                                                    else
                                                        {?>
                                                            <a href="total-user.php" onClick="return confirm('Sorry!!! You are Not Authorised to Modify.');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                 <?php  } ?>  
                                            </td>
                                        </tr>
                                    <?php $cnt = $cnt + 1;
