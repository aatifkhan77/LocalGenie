                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $ret = mysqli_query($conn, "select * from user_profile where (name like '%$searchkey%' || email like '%$searchkey%' || phoneno like '%$searchkey%' || username like '%$searchkey%')");
                                    $cnt = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                if ($superadmin == 'yes') { ?>
                                                    <a href="search-result.php?id=<?php echo $row['userid']; ?>" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <?php } else { ?>
                                                    <a href="search-result.php" onClick="return confirm('Sorry!!! You are Not Authorised to Modify.');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <?php  } ?>
                                            </td>
                                        </tr>
                                    <?php $cnt = $cnt + 1;
