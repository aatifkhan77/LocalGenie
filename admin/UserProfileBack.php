...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($req == "get"){
        ...
        if($aff > 0){
            ...
            $arr=array("isSuccess"=>"success","username"=>$username, "name"=>$name, "email"=>$email,"phoneno"=>$phoneno,"address"=>$address);
        ...
        if($imgName == NULL || $imgName == "" || $imgType == NULL || $imgType == ""){
            ...
            $sql = "UPDATE `user_profile` set `name` = '$name', `email` = '$email',`phoneno` = '$phoneno',`address` = '$address' where `username` = '$username'";
            ...
            $sql = "UPDATE `user_profile` set `name` = '$name', `email` = '$email',`phoneno` = '$phoneno',`address` = '$address',`profilepic` = '$newImgName' where `username` = '$username'";
