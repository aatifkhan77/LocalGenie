...
<head>
    ...
    <title> All  Queries Record </title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">All  Sales Record</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="../dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">All Sales Record</li>
                    </ol>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php $ret = mysqli_query($conn, "Select *
                                        ...
                                        //   $ret1 = mysqli_query($conn, "SELECT MAX(dop) 
                                        //                                FROM sales_record 
                                        //                                WHERE dop < ( SELECT MAX(dop) FROM sales_record)");
