...
<head>
    ...
    <title>Last 7 Days Queries Record </title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Last 7 Days Queries Record </h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="../dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Last 7 Days Queries Record </li>
                    </ol>

                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            Last 7 Days Queries Record
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php $ret = mysqli_query($conn, "Select *
                                                                      ...
                                                                      and date(datetime)>=now() - INTERVAL 7 day");
                                    $cnt = 1;
