    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Edit Genie</h6>
                        <form id="editForm" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="username" class="form-label bg-dark">Username</label>
                                <div type="text" class="form-control bg-dark" id="username" name="username" aria-describedby="username">dummy</div>
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="varchar" class="form-control" id="name" name="name" aria-describedby="name">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="varchar" class="form-control" id="phoneno" name="phoneno"  minlength="10" maxlength="11" aria-describedby="phoneno">
                            </div>
                            <div class="mb-3">
                                <label for="occupation" class="form-label">Occupation</label>
                                <input type="text" class="form-control" id="occupation" name="occupation"  aria-describedby="occupation">
                            </div>
                            <div class="mb-3">
