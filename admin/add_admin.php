                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form id="addForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control bg-dark" type="file" id="uploadDp" name="uploadDp" accept=".jpg, .png, .jpeg, .bmp" required>
                            </div>
                            <fieldset class="row mb-3">
                                <legend class="col-form-label col-sm-2 pt-0">Super Admin</legend>
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="superadmin" id="superadmin" value="yes">
                                        <label class="form-check-label" for="superadmin">
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="superadmin" id="superadmin" value="no" checked>
                                        <label class="form-check-label" for="superadmin">
                                            No
                                        </label>
                                    </div>
